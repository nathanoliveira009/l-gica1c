programa {
  funcao inicio() {
    real valor_conta, porcentagem_gorjeta, gorjeta, total_pagar
     ...
     escreva("Digite a porcentagem da gorjeta: ")
     ...
     escreva("Porcentagem da gorjeta: ", porcentagem_gorjeta, "%\n")
     escreva("Gorjeta: $ ", gorjeta, "\n")
     escreva("Total a pagar: $ ", total_pagar, "\n")
  }
}

// copiei de alguem já que a professora desistiu de ajudar por causa do barulho